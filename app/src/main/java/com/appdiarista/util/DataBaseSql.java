...
public class DataBaseSql {
    ...
    public static String CT_CONTRATO    = "CREATE TABLE contrato (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, dataSolicitacao VARCHAR, dataAceito VARCHAR, contratante_id INTEGER NOT NULL REFERENCES contratante (id), diarista_id INTEGER NOT NULL REFERENCES diarista (id))";
    public static String CT_DIARIA    = "CREATE TABLE diaria (id INTEGER PRIMARY KEY AUTOINCREMENT, data VARCHAR NOT NULL)";
    public static String CT_CONTRATO_DIARIA    = "CREATE TABLE contrato_diaria (contrato_id INTEGER NOT NULL REFERENCES contrato (id), diaria_id INTEGER NOT NULL REFERENCES diaria (id))";

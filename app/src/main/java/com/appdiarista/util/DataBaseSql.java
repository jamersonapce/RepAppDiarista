...
public class DataBaseSql {
    ...
    public static String CT_CONTRATANTE = "CREATE TABLE contratante (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nome VARCHAR NOT NULL, telefone VARCHAR NOT NULL, dataNascimento VARCHAR, cpf VARCHAR NOT NULL, email VARCHAR, sobreMim VARCHAR, valorDiaria DECIMAL NOT NULL, latitude DOUBLE, longitude DOUBLE)";
